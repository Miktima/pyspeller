"""
Django settings for pyspeller_site project.
...
with open(BASE_DIR / "pyspeller_site/secret_key.txt") as f:
...
ROOT_URLCONF = 'pyspeller_site.urls'
...
WSGI_APPLICATION = 'pyspeller_site.wsgi.application'
